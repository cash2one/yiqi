...
def _http_call(api_url, method, authorization, **kw):
    '''
    ...
    if authorization:
        auth_params = _encode_params(
            oauth_consumer_key=authorization.client_id,
    ...
    try:
        ...
        if hasattr(r, 'errorCode'):
            raise APIError(r.errorCode, getattr(r, 'errorMsg', ''), http_url)
    return r
...
class APIClient(object):
    ...
    '''
    def __init__(self, app_key, app_secret, redirect_uri=None, clientip='127.0.0.1', response_type='code', domain='open.t.qq.com'):
